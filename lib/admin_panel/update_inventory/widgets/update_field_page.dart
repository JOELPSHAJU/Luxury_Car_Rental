...
class _UpdateInventoryFieldsState extends State<UpdateInventoryFields> {
  ...
  imagepickerdisplay() async {
    ...
    try {
      await referenceDirImagtoupload.putFile(File(file.path));
      disImage = await referenceDirImagtoupload.getDownloadURL();
      setState(() {});
      if (disImage.isEmpty) {
        // ignore: use_build_context_synchronously
        ScaffoldMessenger.of(context)
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    ...
                    if (docSnapshot.exists) {
                      ...
                      displayImage = data['DissplayImage'];
                                  ...
                                  child: Row(
                                    children: [
                                      ProjectUtils().headingsmall(
                                          ...
                                          color: ProjectColors.primarycolor1,
                                          text:
                                              'SELECT NEW IMAGES OF INVENTORY '),
                                      Icon(
                                        Icons.add_a_photo,
                                        color: ProjectColors.primarycolor1,
                                        size: 27,
